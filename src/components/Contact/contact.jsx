    ...
    <section id="contact"className="min-h-screen overflow-x-hidden bg-linear-to-r from-[#16131D] via-[#241515] to-[#5A220F] text-white pt-16 lg:pt-24">
      <div className="max-w-7xl mx-auto w-full px-5 sm:px-6 lg:px-10 py-12 lg:py-20">
        ...
        <motion.div initial={{ opacity: 0, x: -40 }}  whileInView={{ opacity: 1, x: 0 }}transition={{ duration: .8 }} viewport={{ once: true }} className="bg-white/5 backdrop-blur-md rounded-3xl border border-orange-500/20 p-6 sm:p-8 lg:p-10 space-y-8">
          ...
          {/* Right */}
          <motion.form initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: .8 }} viewport={{ once: true }} className="bg-white/5 backdrop-blur-md border border-orange-500/20 rounded-3xl p-6 sm:p-8 lg:p-10 space-y-6 shadow-lg" >
           <input type="text" placeholder="Your Name"className="w-full bg-[#221A27] border border-white/10 rounded-xl px-4 py-3 text-sm sm:text-base text-white placeholder:text-gray-500 outline-none transition focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20" />
           <input type="email"placeholder="Your Email" className="w-full bg-[#221A27] border border-white/10 rounded-xl px-4 py-3 text-sm sm:text-base text-white placeholder:text-gray-500 outline-none transition focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20"/>
           <input type="text"placeholder="Subject"className="w-full bg-[#221A27] border border-white/10 rounded-xl px-4 py-3 text-sm sm:text-base text-white placeholder:text-gray-500 outline-none transition focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20"/>
           <textarea rows={5} placeholder="Message"className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm sm:text-base outline-none resize-none focus:border-orange-500 transition"></textarea>
