  ...
  return (
    <section id="about" className="min-h-screen bg-linear-to-r from-[#16131D] via-[#241515] to-[#5A220F] text-white flex items-center justify-center px-6">
      <div className="max-w-4xl text-center">
        ...
        <motion.p initial={{ opacity: 0, y: 30 }}whileInView={{ opacity: 1, y: 0 }}transition={{ duration: 1.1 }}viewport={{ once: true }}className="mt-2 text-gray-400 text-base sm:text-lg leading-8 max-w-3xl mx-auto">
